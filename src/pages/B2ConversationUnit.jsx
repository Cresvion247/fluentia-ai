...
import B2UnitNineDocument from "@/components/lessons/B2UnitNineDocument";
import B2UnitTenDocument from "@/components/lessons/B2UnitTenDocument";
import B2UnitElevenDocument from "@/components/lessons/B2UnitElevenDocument";
import B2UnitTwelveDocument from "@/components/lessons/B2UnitTwelveDocument";
import B2UnitThirteenDocument from "@/components/lessons/B2UnitThirteenDocument";
import B2UnitFourteenDocument from "@/components/lessons/B2UnitFourteenDocument";

export default function B2ConversationUnit() {
  const unit = window.location.pathname.split("/").pop()?.replace("unit-", "");
  const [selection, setSelection] = useState("");
  const content = unit === "1" ? <B2UnitOneDocument onSelect={setSelection} /> : unit === "2" ? <B2UnitTwoDocument onSelect={setSelection} /> : unit === "3" ? <B2UnitThreeDocument onSelect={setSelection} /> : unit === "4" ? <B2UnitFourDocument onSelect={setSelection} /> : unit === "5" ? <B2UnitFiveDocument onSelect={setSelection} /> : unit === "6" ? <B2UnitSixDocument onSelect={setSelection} /> : unit === "7" ? <B2UnitSevenDocument onSelect={setSelection} /> : unit === "8" ? <B2UnitEightDocument onSelect={setSelection} /> : unit === "9" ? <B2UnitNineDocument onSelect={setSelection} /> : unit === "10" ? <B2UnitTenDocument onSelect={setSelection} /> : unit === "11" ? <B2UnitElevenDocument onSelect={setSelection} /> : unit === "12" ? <B2UnitTwelveDocument onSelect={setSelection} /> : unit === "13" ? <B2UnitThirteenDocument onSelect={setSelection} /> : unit === "14" ? <B2UnitFourteenDocument onSelect={setSelection} /> : null;
