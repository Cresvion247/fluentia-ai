...
export default function B1ConversationUnit() {
  ...
  const content = unit === "1" ? <B1UnitOneDocument onSelect={setSelection} /> : unit === "2" ? <B1UnitTwoDocument onSelect={setSelection} /> : unit === "3" ? <B1UnitThreeDocument onSelect={setSelection} /> : null;
  const description = unit === "1" ? "Practica el presente simple, el presente continuo y los verbos de estado con preguntas y respuestas modelo." : unit === "2" ? "Practica el pasado simple, el pasado continuo y la estructura used to con preguntas y respuestas modelo." : "Amplía tu vocabulario de deporte, música y entretenimiento con preguntas y respuestas modelo.";
