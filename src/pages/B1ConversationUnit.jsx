...
export default function B1ConversationUnit() {
  ...
  const content = unit === "1" ? <B1UnitOneDocument onSelect={setSelection} /> : unit === "2" ? <B1UnitTwoDocument onSelect={setSelection} /> : unit === "3" ? <B1UnitThreeDocument onSelect={setSelection} /> : unit === "4" ? <B1UnitFourDocument onSelect={setSelection} /> : unit === "5" ? <B1UnitFiveDocument onSelect={setSelection} /> : null;
  const description = unit === "1" ? "Practica el presente simple, el presente continuo y los verbos de estado con preguntas y respuestas modelo." : unit === "2" ? "Practica el pasado simple, el pasado continuo y la estructura used to con preguntas y respuestas modelo." : unit === "3" ? "Amplía tu vocabulario de deporte, música y entretenimiento con preguntas y respuestas modelo." : unit === "4" ? "Practica el present perfect y el present perfect continuous con preguntas y respuestas modelo." : "Practica el past perfect y el past perfect continuous con preguntas y respuestas modelo.";
