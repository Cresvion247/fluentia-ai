...
import { getCommonProblemsHeading } from "@/lib/common-problems-headings";
...
export default function CommonProblemsDocument({ onSelect }) {
  return <DocxTableDocument sourceUrl={sourceUrl} onSelect={onSelect} getSectionHeading={getCommonProblemsHeading} />;
}