...
export default function AppShell({ children }) {
  ...
  const links = [["Inicio", "/"], ["Pronunciación", "/pronunciacion"], ["Letras Mudas", "/letras-silenciosas"], ["Common Problems", "/common-problems"], ["EngSpan", "/engspan"], ["Phrasal Verbs", "/phrasal-verbs"], ["Verbs + Prepositions", "/verbs-prepositions"], ["Idioms and Expressions", "/idioms-expressions"], ["Ing or Infinitive", "/ing-or-infinitive"], ["Do vs. Make", "/do-vs-make"], ["B1 Conversation", "/b1-conversation"], ["B2 Conversation", "/b2-conversation"], ["C1 Conversation", "/c1-conversation"], ["Escritura", "/escritura"], ["Expresión oral", "/expresion-oral"]];
