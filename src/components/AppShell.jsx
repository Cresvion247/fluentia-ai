...
export default function AppShell({ children }) {
  ...
  const links = [["Inicio", "/"], ["Pronunciación", "/pronunciacion"], ["Letras Mudas", "/letras-silenciosas"], ["Common Problems", "/common-problems"], ["EngSpan", "/engspan"], ["Phrasal Verbs", "/phrasal-verbs"], ["Verbs + Prepositions", "/verbs-prepositions"], ["Idioms and Expressions", "/idioms-expressions"], ["Ing or Infinitive", "/ing-or-infinitive"], ["Do vs. Make", "/do-vs-make"], ["Conditionals", "/inversion-conditionals"], ["Comparative & Superlative", "/comparative-superlative"], ["Causative", "/causative"], ["Direct & Indirect Questions", "/direct-indirect-questions"], ["Infinitive of Purpose", "/infinitive-of-purpose"], ["Modal Verbs", "/modal-verbs"], ["Negative Infinitive", "/negative-infinitive"], ["Participle Clause", "/participle-clause"], ["Passive Voice", "/passive-voice"], ["Phrasal Nouns", "/phrasal-nouns"], ["Prepositions of Time & Place", "/prepositions-time-place"], ["Relative Pronouns", "/relative-pronouns"], ["Reporting Verbs", "/reporting-verbs"], ["Unreal", "/unreal"], ["Tenses", "/tenses"], ["Articles", "/articles"], ["Used to & Would", "/used-to-would"], ["Used to vs. Be used to", "/used-to-vs-be-used-to"], ["Similes and Metaphors", "/similes-metaphors"], ["Affixes", "/affixes"], ["Soft Skills", "/soft-skills"], ["Business", "/business"], ["B1 Conversation", "/b1-conversation"], ["B2 Conversation", "/b2-conversation"], ["C1 Conversation", "/c1-conversation"], ["Escritura", "/escritura"], ["Expresión oral", "/expresion-oral"]];
  return <div className="min-h-screen bg-[#f7f9ff] text-slate-900 dark:bg-[#09111f] dark:text-slate-100">
    ...
    {location.pathname !== "/" && <div className="mx-auto max-w-4xl px-5 pt-6"><Link to={returnPath} className="inline-block font-medium text-indigo-600 hover:text-indigo-700">{returnLabel}</Link></div>}
    {children}
    {location.pathname !== "/" && <div className="mx-auto max-w-4xl px-5 pb-10 pt-6"><Link to={returnPath} className="inline-block font-medium text-indigo-600 hover:text-indigo-700">{returnLabel}</Link></div>}
  </div>;
}